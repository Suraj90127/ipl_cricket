...
export default function PaymentPage() {
    ...
    bg-gradient-to-br from-[#0b1220] via-[#071a1a] to-[#05070f] text-white">
      ...
      border border-white/10 backdrop-blur-xl shadow-lg">
            ...
            <div className="mt-6 p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl">
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <button className="flex items-center gap-2 p-3 rounded-xl 
      ...
      bg-white/5 border border-white/10 backdrop-blur-xl">
                ...
                <div className="mb-4">
                    ...
                    <div className="flex gap-2">
                        <input
                            ...
                            className="flex-1 bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-teal-400/40"
                        />
                ...
                {/* PAY BUTTON */}
                <a
                    href={`upi://pay?pa=${upiId}&pn=YourApp&am=${amount}&cu=INR`}
                    className="block text-center mb-4 py-2 rounded-xl 
          ...
          bg-white/5 border border-white/10 rounded-xl px-3 py-2">
                ...
                <div className="mt-4">
                    ...
                    <div className="flex gap-2">
                        <input
                            ...
                            className="flex-1 bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-teal-400/40"
                        />
              ...
              text-black font-semibold text-sm shadow-lg hover:scale-105 transition"
                        >
                            Submit
                        </button>
                    </div>
            ...
            {showQR && (
                <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
                    <div className="bg-[#0b1220] border border-white/10 rounded-2xl p-6 text-center">
                        ...
                        <img
                            src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=upi://pay?pa=${upiId}&pn=YourApp&am=${amount}&cu=INR`}
                            alt="QR Code"
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-teal-500 text-black rounded-xl font-semibold"
                        >
                            Close
                        </button>
